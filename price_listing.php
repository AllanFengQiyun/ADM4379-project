...
<?php
    ...
    <div class="flex flex-wrap grow-0 justify-center gap-4">
        <!-- first box-->
        <div
            class="w-full max-w-sm border border-gray-200 rounded-lg shadow bg-gray-800 border-gray-700">
            <a href="#">
                <img class="p-8 object-scale-down rounded-t-lg"
                    src="https://media.direct.playstation.com/is/image/sierialto/GOWR-Bundle-Hero-US?$Background_Large$"
                    alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
                ...
                <div class="flex items-center mt-2.5 mb-5">
                    ...
                    <span
                        class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded bg-blue-200 text-blue-800 ml-3">5.0</span>
                </div>
        ...
        <div
            ...
            <a href="#">
                <img class="p-8 object-scale-down rounded-t-lg"
                    src="https://media.direct.playstation.com/is/image/sierialto/GOWR-PS5-Digital-Bundle-Hero-US?$Background_Large$"
                    alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
        ...
        <div
            ...
            <a href="#">
                <img class="p-8 object-scale-down rounded-t-lg "
                    src="https://m.media-amazon.com/images/I/51QnZ0TtL2L._AC_SL1500_.jpg" alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
                    <h5 class="text-xl font-semibold tracking-tight  text-white">Playstation 5 Console
        ...
        <div class="px-5 pb-5">
            ...
            <div class="flex items-center mt-2.5 mb-5">
                ...
                <span
                    class="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded bg-blue-200 text-blue-800 ml-3">4.0</span>
            </div>
            <div class="flex items-center justify-between">
